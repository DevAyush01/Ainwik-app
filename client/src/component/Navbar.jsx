    ...
    <div className="w-full h-full  shadow-xl">
      <header className=" ">
        ...
        <ul className= " hidden xl:flex items-center gap-4 font-semibold text-base absolute right-[270px]">
          ...
          <li className="peer p-3 hover:bg-sky-400 hover:text-white rounded-md transtion-all cursor-pointer hover:display-block flex gap-4">
         ...
         w-[220px] 
         flex-col bg-white drop-shadow-lg rounded-md   gap-4  hover:-transition-all duration-150 ease-in "
          > 
            ...
            {/* <li className="cursor-pointer hover:bg-sky-400 flex gap-4">Mern-Stack <img src={mern} alt="" className=" w-8 h-3" /></li> */}
